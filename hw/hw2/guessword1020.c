          ...
          else
          {
            ...
            else
            {
              ...
              //case to calculate the right word and right position.
            	int secretwordorder,userwordorder, secretwordsame=0, userwordsame=0;
            	for(secretwordorder = 0; secretwordorder < strlen(cpy_secretword); secretwordorder++)
            	{
            		for(userwordorder = 0; userwordorder < strlen(cpy_secretword); userwordorder++)
            		{
            			if(client[i].word[userwordorder] == cpy_secretword[secretwordorder])
            			{

                    		if(   ((secretwordsame != userwordorder) && (userwordsame != userwordorder)) || ((secretwordorder ==0) && (userwordorder == 0 ))  )
                    		{
                    			samecharacter++;
                    		}

            				secretwordsame = secretwordorder;
                    		userwordsame = userwordorder;


            				if(secretwordorder == userwordorder)
            				{
            					samelocation++;
            				}
            			}
              ...
              else
              {
                ...
                //
            		// sameword_char[0] = sameword + '0';
            		// samelocation_char[0] = samelocation + '0';
