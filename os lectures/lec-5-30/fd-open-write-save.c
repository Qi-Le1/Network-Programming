...
int main()
{
  ...
  /* first "save" stdout (fd 1) to another descriptor */
  int saved_fd = dup( 1 );
  printf( "(copied fd 1 to fd %d)\n", saved_fd );
  ...
  /* restore saved_fd back to stdout */
  dup2( saved_fd, 1 );
  ...
  printf( "this should go to the terminal......?\n" );

  /* could also close(saved_fd) at this point.... */
